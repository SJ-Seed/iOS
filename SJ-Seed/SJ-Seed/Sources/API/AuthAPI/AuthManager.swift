...
final class AuthManager {
    ...
    // 개발용 하드코딩 토큰
    private let devToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJzdHJpbmciLCJpYXQiOjE3NjM5OTE3MDQsImV4cCI6MTc2NDA3ODEwNH0.gnPWA3-mijMA2WMCwgVRgvN1xGDYIYGlLnA8nB5tswc"

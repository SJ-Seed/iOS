...
final class AuthManager {
    ...
    // 개발용 하드코딩 토큰
    private let devToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJzdHJpbmciLCJpYXQiOjE3NjI4NDUxMzksImV4cCI6MTc2MjkzMTUzOX0.aZpQHO-cqMq5dYTOmKf7LBeGYsZmTeJ7830rwXSkPBM"
